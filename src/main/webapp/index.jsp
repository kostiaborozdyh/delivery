    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="/main.jsp" class="nav-item nav-link ">Головна</a>
                <a href="#" class="nav-item nav-link">Про нас</a>
                <a href="/index.jsp" class="nav-item nav-link active">Напрямки доставки</a>
            ...
            <table class="table table-borderless">
                ...
                <c:forEach var="table" items="${sessionScope.infoTableShort}">
                    <tr>
                        ...
                        <td class="bg-light"><a href="<c:url value="/printMap?id=${table.id}"/>">Мапа</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
