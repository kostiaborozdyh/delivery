...
<body>
<form method="post" action="<c:url value='/registrationUser'/>">
    ...
    <input type="checkbox" name="notify" value="notifyEmail">Отримувати повідомлення на пошту<br>
    <input type="submit" value="Зареєструватися" name="Ok"><br>
</form>
</body>
</html>
